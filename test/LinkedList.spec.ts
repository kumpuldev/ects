...
describe("LinkedList", () => {
  it("should initiate list with one element", () => {
    const list = new LinkedList<number>(2);
    expect(list.head.value).eq(2);
  },
  );

  it("should initiate list with multiple element", () => {
  ...
  it("should determine whether the given value is an LinkedList", () => {
  ...
  it("should push multiple element", () => {
    const list = new LinkedList<unknown>();
    list.push(12, 33, 44);
